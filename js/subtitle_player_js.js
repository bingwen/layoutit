...
function position_sub_index() {
    // item 79
    var i = sub_index_en.length;
    while (sub_index_en[--i] < elapse_from_start);
...
function disp_sub_by_lang(disp_lang_array) {
    ...
    while (true) {
        ...
        // item 89
        eval("$('.srt-" + item + "').text(sub_text_" + item + "[" + subtitle_index + "])");
        // item 870003
        _ind87++;
    }
}
...
function subtitle_player() {
    ...
    while (true) {
        ...
        if (disp_lang_indi == 0) {
            ...
            // item 37
            flashplayer_curtime = currentTime();
            // item 19
